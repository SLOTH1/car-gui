...
class MainWindow(QMainWindow):
  ...
  def update_car(self):
    ...
    if row.rowcount > 0:
      QMessageBox.information(self, 'Information','Update car successful!')
      self.show_all_cars()
    else:
      QMessageBox.warning(self, 'Warning','Unable to update car!')
  ...
  def delete_car(self):
    ...
    if row.rowcount > 0:
      QMessageBox.information(self, 'Information','Delete car successful!')
      self.show_all_cars()
    else:
      QMessageBox.warning(self, 'Warning','Unable to delete car!')
  ...
  def show_cars(self, cars):
      ...
      row = 0
      for car in cars: #car => [0] (1, 'Toyota', 'Yaris', 2025, 867778)
